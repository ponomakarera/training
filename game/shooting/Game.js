...
gameini.images.push({type:"dxy", src:"../rsrc/image/player.png", dx:this.x, dy:this.y});
}
...
if (this.shot[i].exist) {
if (this.shot[i].burstshot) {
gameini.images.push({type:"dxy", src:"../rsrc/image/burstshot.png", dx:this.shot[i].x, dy:this.shot[i].y});
}
else {
gameini.images.push({type:"dxy", src:"../rsrc/image/shot.png", dx:this.shot[i].x, dy:this.shot[i].y});
}
}
}
} 
